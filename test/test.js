...
test('date formatting', (t) => {
  ...
  const out1 = '1994 94 / 11 11 November Nov - 7 7th 07 -- Tuesday -- Tue Tu T 6 06 06 6 am AM 25 04';
  const out2 = '2001 01 / 01 1 January Jan - 1 1st 01 -- Tuesday -- Tue Tu T 2 02 02 2 am AM 00 30';
  const out3 = '2013 13 / 12 12 December Dec - 2 2nd 02 -- Tuesday -- Tue Tu T 12 12 12 12 pm PM 00 00';
  const out4 = '2050 50 / 11 11 November Nov - 22 22nd 22 -- Wednesday -- Wed We W 0 00 12 12 am AM 00 00';
  const out5 = '2050 50 / 11 11 November Nov - 22 22nd 22 -- Wednesday -- Wed We W 16 16 04 4 pm PM 00 00';
